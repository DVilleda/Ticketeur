...
public class Billet {
    ...
    public Billet(int idBillet, String titre, LocalDate dateSoumis, String contenu,
                  LocalDate dateLimite, String unAuteur, String nomProjet) {
    ...
    //Methodes des parametres de la classe Billet
    ...
    /**
     * La methode toString pour pouvoir lire les informations d'un billet
     * @return le Billet en format String
     */
    @Override
